...
class slot_training_class():
    ...
    def import_data(self, debug=True):
        '''
                    ...
                    if self.train_method=='old':
                       ...
                       # bar = progressbar.ProgressBar(max_value=range_each_chunks, redirect_stdout=True, end=' ', flush=True)
                        ...
                        for j in range(range_each_chunks):
                            ...
                            _, cost_value = sess.run([optimizer, cost], feed_dict={input_placeholder: epoch_x,
                                                     labels_placeholder: epoch_y, sequence_length_placeholder: inputs_length})
...
if __name__ == "__main__":
    ...
    # Give format Hours, Minutes Seconds
    hours = temp//3600 # Integer division
    temp = temp - 3600*hours
    minutes = temp//60
    seconds = temp - 60*minutes
    print('======================================================')
    print('Total training time {}:{}:{} '.format(hours, minutes,seconds))
    print('======================================================')
